...
~~~~~~~~~~~~~~~~~~~~~~
 ...
 部分协议的请求限制与API用户等级相关，划分如下：用户净资产大于 :red-strengthen:`10000` 港币为 :red-strengthen:`二级用户`，小于 :red-strengthen:`10000` 港币为 :red-strengthen:`三级用户` ，:red-strengthen:`一级用户` 需要与富途联系获取。
...
~~~~~~~~~~~~~~
	* 请求协议ID: 2202_
	* :red-strengthen:`30` 秒内请求次数最多 :red-strengthen:`15` 次，同 :red-strengthen:`1` 秒内最多 :red-strengthen:`5` 次
	
	
交易改单限制
~~~~~~~~~~~~~~
	* 请求协议ID: 2205_
	* :red-strengthen:`30` 秒内请求次数最多 :red-strengthen:`20` 次，同 :red-strengthen:`1` 秒内最多 :red-strengthen:`5` 次
...
~~~~~~~~~~~~~~
  * 请求协议ID: 3001_
  * futu-api支持多种实时数据类型的定阅，参见 SubType_ , 一支股票订阅一个类型就占用一个额度。
  * 订阅额度上限与用户等级相关， 一级: :red-strengthen:`1000` , 二级: :red-strengthen:`300` , 三级: :red-strengthen:`100`  
  * 同种股票和订阅类型在成功订阅后至少一分钟后才能反订阅
	

行情在线历史K线限制
~~~~~~~~~~~~~~~~~~~~~~~~~~
  * 请求协议ID: 3103_
  * :red-strengthen:`30` 天内在线获取历史K线最多可请求股票数与用户等级相关, 一级: :red-strengthen:`1000` , 二级: :red-strengthen:`300` , 三级: :red-strengthen:`100`  
